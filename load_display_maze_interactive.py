...
def find_next_set_images(location_x,location_y,heading,file_database_sorted,image_found):
    ...
    if matched_x_loc.size<4:
        ...
        return (0,0,heading,direction_vector)
    ...
    image_found=1    
    return (resized_img,image_found,heading,direction_vector)
...
resized_img,image_found,new_heading_ind,direction_vector=find_next_set_images(location_x,location_y,heading_ind,file_database_sorted,0)
...
#        break
        ...
        resized_img, image_found,new_heading_ind,direction_vector=find_next_set_images(new_location_x,new_location_y,new_heading_ind,file_database_sorted,0)
        if image_found==0:
            print "No image"
            new_location_x -=direction_vector[0]
        else:
